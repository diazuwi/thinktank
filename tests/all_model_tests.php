...
require_once $SOURCE_ROOT_PATH.'tests/TestOfInstaller.php';
require_once $SOURCE_ROOT_PATH.'tests/TestOfInstallerMySQLDAO.php';
require_once $SOURCE_ROOT_PATH.'tests/TestOfInstanceMySQLDAO.php';
require_once $SOURCE_ROOT_PATH.'tests/TestOfLoader.php';
