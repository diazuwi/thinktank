 ...
 * The data access object for ThinkUp installation
 * 
...
class InstallerMySQLDAO extends PDODAO implements InstallerDAO  {
    ...
    /**
     * We override the PDODAO so we can use
     * installerConnect to connect the database
    ...
    /**
     * Connection initiator for Installer
     * 
     * @param array $config Array of configuration
     * @return object PDO Instance
     */
    public function installerConnect($config){
        if (is_null(self::$PDO)) {
     ...
     * 
     * @param string $tablename
     * @return array Tables indices of $tablename
     */
